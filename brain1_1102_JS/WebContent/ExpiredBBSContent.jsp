...
<body>
    ...
    <div>
        ...
        <table id="conten">    
        	<tr>
             <th><h2>${expiredBBSDTO.title}</h2></th>
             <th><h2>${expiredBBSDTO.date}</h2></th>
         	</tr>
            <tr>
                <td>${expiredBBSDTO.content}</td>
            </tr>
		<tr>
     		<td style="border:none">
            	<a href="./expiredBBSView" class="table" style="margin-right:-4%; padding:1% 2%" >목록</a>
                <a href="./expiredBBSDelte?seqNo=${expiredBBSDTO.seqNo}" class="write">삭제</a>   
        	</td>
    	</tr>
	</table>
</body>
